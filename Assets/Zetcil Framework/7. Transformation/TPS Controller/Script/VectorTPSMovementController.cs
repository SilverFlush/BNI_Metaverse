...
namespace Zetcil
{
    public class VectorTPSMovementController : MonoBehaviour
    {
        ...
        public VarVector3 TargetVectorPosition;
        ...
        [HideInInspector] public VectorTPSMovementController cc;
        ...
        {
            cc = GetComponent<VectorTPSMovementController>();
        ...
        {
            cc.input.x = TargetVectorPosition.CurrentValue.x;
            cc.input.z = TargetVectorPosition.CurrentValue.y;
        }
