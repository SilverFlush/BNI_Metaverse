...
namespace Zetcil
{
    public class VectorTPSCameraController : MonoBehaviour
    {
        ...
        public VarVector3 TargetVectorRotation;
        ...
        void Update()
        {
            ...
            if (TargetPlayer && TargetCamera && MouseLookActive)
            {
                ...
                else
                {
                    ...
                    {
                        x += TargetVectorRotation.CurrentValue.x * mouseXSpeed * Time.deltaTime;
                        y -= TargetVectorRotation.CurrentValue.y * mouseYSpeed * Time.deltaTime;
