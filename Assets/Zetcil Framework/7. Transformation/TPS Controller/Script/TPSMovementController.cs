...
public class TPSMovementController : MonoBehaviour
{
    ...
    public void CreateAnimator()
    {
        ...
        {
            if (transform.GetChild(i).gameObject.GetComponent<Animator>())
            {
                TargetAnimator = transform.GetChild(i).gameObject.GetComponent<Animator>();
                TargetAnimator.applyRootMotion = false;
                TargetAnimator.runtimeAnimatorController = Resources.Load("TPSController") as RuntimeAnimatorController;
            }
        }
    }
